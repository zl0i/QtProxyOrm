...
ApplicationWindow {
    ...
    Row {
        ...
        Column {
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        Label {
                            text: qsTr("number: %1 total: %2").arg(
                                      numberRole).arg(totalRole)
                        }
                    }
                    Rectangle {
                        y: parent.height
            ...
            Row {
                ...
                Button {
                    ...
                    onClicked: () => {
                                   orderModel.update()
                                   // console.log(variant(totalOrder)))
                               }
                }
            }
        }
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        Label {
                            text: qsTr("title: %1 rate: %2").arg(
                                      titleRole).arg(rateRole)
                        }
                    }
                    Rectangle {
                        y: parent.height
        ...
        Column {
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    height: 25
                    Label {
                        text: qsTr("id: %1 %2 %3 email: %4").arg(idRole).arg(
                                  firstnameRole).arg(lastnameRole).arg(
                                  emailRole)
                    }
        ...
        Column {
            ...
            spacing: 20
            Label {
                property variant total: totalOrder
                text: "proxyValue :" + total
            }
            Label {
                text: "proxyModel"
            }
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Column {
                        ...
                        Label {
                            text: qsTr("id: %1 number: %2 total: %3 user: %4 %5").arg(
                                      idRole).arg(numberRole).arg(
                                      totalRole).arg(firstnameRole).arg(
                                      lastnameRole)
                        }
                        Label {
                            text: qsTr("staff: %1 rate: %2 count: %3 total: %4 case: %5").arg(
                                      staffNameRole).arg(staffRateRole).arg(
                                      countOrderRole).arg(
